...
-(IBAction)backButtonClicked{
    [[(AppDelegate *)[UIApplication sharedApplication].delegate getSidebarVC] openSidebar];
}
...
- (void)viewDidLoad
{
    [[NSUserDefaults standardUserDefaults] setObject:@"Chat" forKey:@"current view controller"];
    self.delegate = self;
